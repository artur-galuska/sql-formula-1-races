...
It follows a set of 45 tasks, with increasing difficulty, that must be found by using SQL on the imported datasets of races.
...
The project is provided in .pdf format, as well as with the datasets.
Download and import the datasets, and then use queries from .pdf to provide the answers to tasks.
